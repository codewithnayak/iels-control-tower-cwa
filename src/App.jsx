...
import { IelsFooter } from "./components/footer";
import { IelsHeader } from "./components/header";
...
export default function App() {
  const user = {
    name: "Sudhansu Nayak",
    avatarUrl: "https://your-cdn/avatar.png",
  };

  return (
    <>
      <IelsHeader user={user} onSignOut={() => alert("sign out")} />
      <Routes>
        {/* Dashboard */}
